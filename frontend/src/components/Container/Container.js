...
const defaultContainerClasses = "z-0 transform duration-200 lg:flex-grow pt-20 ";
  ...
  return (
    <div
      className={
        ...
        (isOpenClientSelector || isOpenProductSelector ? " fixed-body-scroll" : "")
      }
    >
      <Navbar />
      <Sidebar />
      ...
      >
        <div
          className={
            "container mx-auto " +
            (showNavbar ? "scale-50 origin-top ease-in sm:origin-center sm:scale-100" : "")
          }
        >
          {children}
        </div>
