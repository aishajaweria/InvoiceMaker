...
import { AppCtx } from "./context/AppContext"; // Import the context
...
const App = () => {
  ...
  const { isLoggedIn, isRegistered, handleRegister , handleLogin } = useContext(AppCtx);
        ...
        <Routes>
          {!isRegistered ? (
            ...
            <>
              ...
              {/* Define the route for "/register" path here */}
              <Route path="/register" element={<Register handleRegister={handleRegister} />} />
              <Route path="/login" element={<Login handleLogin={handleLogin} />} />
            </>
          )}
